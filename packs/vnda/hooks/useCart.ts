...
const state = {
  ...
  loading,
  addItem: wrap(
    Runtime.create("deco-sites/std/actions/vnda/cart/addItem.ts"),
  ),
  updateItem: wrap(
    Runtime.create("deco-sites/std/actions/vnda/cart/updateItem.ts"),
  ),
  setShippingAddress: wrap(
    Runtime.create("deco-sites/std/actions/vnda/cart/setShippingAddress.ts"),
  ),
  updateCoupon: wrap(
    Runtime.create("deco-sites/std/actions/vnda/cart/updateCoupon.ts"),
  ),
};
