...
import * as $$1 from "./accounts/butterCMS.ts";
...
import * as $$6 from "./accounts/linxImpulse.ts";
import * as $$7 from "./accounts/yourViews.ts";
import * as $$$0 from "./loaders/x/redirects.ts";
import * as $$$1 from "./loaders/x/image.ts";
import * as $$$2 from "./loaders/x/font.ts";
import * as $$$3 from "./loaders/x/realtime.ts";
import * as $$$4 from "./loaders/x/redirectsFromCsv.ts";
import * as $$$5 from "./loaders/vnda/cart.ts";
import * as $$$6 from "./loaders/vnda/productListingPage.ts";
import * as $$$7 from "./loaders/vnda/proxy.ts";
import * as $$$8 from "./loaders/vnda/productList.ts";
import * as $$$9 from "./loaders/vnda/productDetailsPage.ts";
import * as $$$10 from "./loaders/nuvemShop/nuvemShopProductDetailsPage.ts";
import * as $$$11 from "./loaders/nuvemShop/nuvemShopProductList.ts";
import * as $$$12 from "./loaders/nuvemShop/nuvemShopProductListingPage.ts";
import * as $$$13 from "./loaders/linxImpulse/search.ts";
import * as $$$14 from "./loaders/linxImpulse/autocompletes/suggestions.ts";
import * as $$$15 from "./loaders/linxImpulse/autocompletes/popular.ts";
import * as $$$16 from "./loaders/linxImpulse/products/similarItems.ts";
import * as $$$17 from "./loaders/linxImpulse/pages/recommendations.ts";
import * as $$$18 from "./loaders/vtex/cart.ts";
import * as $$$19 from "./loaders/vtex/user.ts";
import * as $$$20 from "./loaders/vtex/proxy.ts";
import * as $$$21 from "./loaders/vtex/legacy/productListingPage.ts";
import * as $$$22 from "./loaders/vtex/legacy/productList.ts";
import * as $$$23 from "./loaders/vtex/legacy/productDetailsPage.ts";
import * as $$$24 from "./loaders/vtex/legacy/relatedProductsLoader.ts";
import * as $$$25 from "./loaders/vtex/wishlist.ts";
import * as $$$26 from "./loaders/vtex/navbar.ts";
import * as $$$27 from "./loaders/vtex/intelligentSearch/suggestions.ts";
import * as $$$28 from "./loaders/vtex/intelligentSearch/productListingPage.ts";
import * as $$$29 from "./loaders/vtex/intelligentSearch/productList.ts";
import * as $$$30 from "./loaders/vtex/intelligentSearch/productDetailsPage.ts";
...
import * as $$$$$$$$7 from "./sections/configLinxImpulse.global.tsx";
import * as $$$$$$$$8 from "./sections/configVTEX.global.tsx";
import * as $$$$$$$$9 from "./sections/AnalyticsRealtime.tsx";
import * as $$$$$$$$10 from "./sections/configYourViews.global.tsx";
import * as $$$$$$$$11 from "./sections/configNuvemShop.tsx";
import * as $$$$$$$$12 from "./sections/configButterCMS.global.tsx";
import * as $$$$$$$$$$$0 from "./actions/vnda/cart/updateItem.ts";
...
import * as $$$$$$$$$$$5 from "./actions/vtex/cart/updateItemPrice.ts";
import * as $$$$$$$$$$$6 from "./actions/vtex/cart/updateCoupons.ts";
import * as $$$$$$$$$$$7 from "./actions/vtex/cart/removeItemAttachment.ts";
import * as $$$$$$$$$$$8 from "./actions/vtex/cart/simulation.ts";
import * as $$$$$$$$$$$9 from "./actions/vtex/cart/updateItems.ts";
import * as $$$$$$$$$$$10 from "./actions/vtex/cart/addItems.ts";
import * as $$$$$$$$$$$11 from "./actions/vtex/cart/removeItems.ts";
import * as $$$$$$$$$$$12 from "./actions/vtex/cart/getInstallment.ts";
import * as $$$$$$$$$$$13 from "./actions/vtex/cart/updateItemAttachment.ts";
import * as $$$$$$$$$$$14 from "./actions/vtex/cart/updateProfile.ts";
import * as $$$$$$$$$$$15 from "./actions/vtex/cart/updateAttachment.ts";
import * as $$$$$$$$$$$16 from "./actions/vtex/analytics/sendEvent.ts";
import * as $$$$$$$$$$$17 from "./actions/vtex/notifyme.ts";
import * as $$$$$$$$$$$18 from "./actions/vtex/wishlist/addItem.ts";
import * as $$$$$$$$$$$19 from "./actions/vtex/wishlist/removeItem.ts";
...
const manifest = {
  ...
  "accounts": {
    "deco-sites/std/accounts/butterCMS.ts": $$1,
    "deco-sites/std/accounts/linxImpulse.ts": $$6,
  ...
  "loaders": {
    ...
    "deco-sites/std/loaders/linxImpulse/autocompletes/popular.ts": $$$15,
    "deco-sites/std/loaders/linxImpulse/autocompletes/suggestions.ts": $$$14,
    "deco-sites/std/loaders/linxImpulse/pages/recommendations.ts": $$$17,
    "deco-sites/std/loaders/linxImpulse/products/similarItems.ts": $$$16,
    "deco-sites/std/loaders/linxImpulse/search.ts": $$$13,
    "deco-sites/std/loaders/nuvemShop/nuvemShopProductDetailsPage.ts": $$$10,
    "deco-sites/std/loaders/nuvemShop/nuvemShopProductList.ts": $$$11,
    "deco-sites/std/loaders/nuvemShop/nuvemShopProductListingPage.ts": $$$12,
    "deco-sites/std/loaders/vnda/cart.ts": $$$5,
    "deco-sites/std/loaders/vnda/productDetailsPage.ts": $$$9,
    "deco-sites/std/loaders/vnda/productList.ts": $$$8,
    "deco-sites/std/loaders/vnda/productListingPage.ts": $$$6,
    "deco-sites/std/loaders/vnda/proxy.ts": $$$7,
    "deco-sites/std/loaders/vtex/cart.ts": $$$18,
    "deco-sites/std/loaders/vtex/intelligentSearch/productDetailsPage.ts":
      $$$30,
    "deco-sites/std/loaders/vtex/intelligentSearch/productList.ts": $$$29,
    "deco-sites/std/loaders/vtex/intelligentSearch/productListingPage.ts":
      $$$28,
    "deco-sites/std/loaders/vtex/intelligentSearch/suggestions.ts": $$$27,
    "deco-sites/std/loaders/vtex/legacy/productDetailsPage.ts": $$$23,
    "deco-sites/std/loaders/vtex/legacy/productList.ts": $$$22,
    "deco-sites/std/loaders/vtex/legacy/productListingPage.ts": $$$21,
    "deco-sites/std/loaders/vtex/legacy/relatedProductsLoader.ts": $$$24,
    "deco-sites/std/loaders/vtex/navbar.ts": $$$26,
    "deco-sites/std/loaders/vtex/proxy.ts": $$$20,
    "deco-sites/std/loaders/vtex/user.ts": $$$19,
    "deco-sites/std/loaders/vtex/wishlist.ts": $$$25,
    "deco-sites/std/loaders/x/font.ts": $$$2,
    "deco-sites/std/loaders/x/image.ts": $$$1,
    "deco-sites/std/loaders/x/realtime.ts": $$$3,
    "deco-sites/std/loaders/x/redirects.ts": $$$0,
    "deco-sites/std/loaders/x/redirectsFromCsv.ts": $$$4,
  },
  "routes": {
    "./routes/_app.tsx": $$$$1,
    "./routes/404.tsx": $$$$0,
  ...
  "sections": {
    ...
    "deco-sites/std/sections/AnalyticsRealtime.tsx": $$$$$$$$9,
    "deco-sites/std/sections/configButterCMS.global.tsx": $$$$$$$$12,
    "deco-sites/std/sections/configLinxImpulse.global.tsx": $$$$$$$$7,
    ...
    "deco-sites/std/sections/configYourViews.global.tsx": $$$$$$$$10,
  ...
  "actions": {
    ...
    "deco-sites/std/actions/vnda/cart/updateItem.ts": $$$$$$$$$$$0,
    "deco-sites/std/actions/vtex/analytics/sendEvent.ts": $$$$$$$$$$$16,
    "deco-sites/std/actions/vtex/cart/addItems.ts": $$$$$$$$$$$10,
    "deco-sites/std/actions/vtex/cart/getInstallment.ts": $$$$$$$$$$$12,
    "deco-sites/std/actions/vtex/cart/removeItemAttachment.ts": $$$$$$$$$$$7,
    "deco-sites/std/actions/vtex/cart/removeItems.ts": $$$$$$$$$$$11,
    "deco-sites/std/actions/vtex/cart/simulation.ts": $$$$$$$$$$$8,
    "deco-sites/std/actions/vtex/cart/updateAttachment.ts": $$$$$$$$$$$15,
    "deco-sites/std/actions/vtex/cart/updateCoupons.ts": $$$$$$$$$$$6,
    "deco-sites/std/actions/vtex/cart/updateItemAttachment.ts": $$$$$$$$$$$13,
    "deco-sites/std/actions/vtex/cart/updateItemPrice.ts": $$$$$$$$$$$5,
    "deco-sites/std/actions/vtex/cart/updateItems.ts": $$$$$$$$$$$9,
    "deco-sites/std/actions/vtex/cart/updateProfile.ts": $$$$$$$$$$$14,
    "deco-sites/std/actions/vtex/cart/updateUser.ts": $$$$$$$$$$$4,
    "deco-sites/std/actions/vtex/newsletter/subscribe.ts": $$$$$$$$$$$20,
    "deco-sites/std/actions/vtex/notifyme.ts": $$$$$$$$$$$17,
    "deco-sites/std/actions/vtex/wishlist/addItem.ts": $$$$$$$$$$$18,
    "deco-sites/std/actions/vtex/wishlist/removeItem.ts": $$$$$$$$$$$19,
  },
  "pages": {
