...
export type SiteStateProperties = Record<string, unknown>;
...
export interface Product {
  ...
  relatedMediaContent: unknown[];
  salePrice: number;
  fullImageURLs: string[];
  length: number;
  x_gender: null;
  derivedDirectCatalogs: unknown[];
